            ...
            <ul className="social-list">
                <li className='social-item'>
                    <a
                        ...
                        <svg className='social-icon' aria-hidden='true' width="25" height="15" viewBox="0 0 25 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <li className='social-item'>
                    <a
                        ...
                        <svg className='social-icon' aria-hidden='true' width="18" height="17" viewBox="0 0 18 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                ...
                <li className='social-item'>
                    <a
                        ...
                        <svg className='social-icon' aria-hidden='true' width="23" height="18" viewBox="0 0 23 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
